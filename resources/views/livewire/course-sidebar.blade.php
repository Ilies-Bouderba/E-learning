<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('announcements.index', $course) }}" class="sidebar-link {{ $active == 'announcements' ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 11 19-9-9 19-2-8-8-2z"/></svg>
            Announcements
        </a>
        ...
        @if(auth()->user()->isTeacher())
            ...
            <a href="{{ route('teacher.exams.index', $course) }}" class="sidebar-link {{ $active == 'exams' ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                Exams
            </a>
            <a href="{{ route('gradebook.index', $course) }}" class="sidebar-link {{ $active == 'gradebook' ? 'active' : '' }}">
        ...
        @elseif(auth()->user()->isStudent())
            ...
            <a href="{{ route('student.exams.index', $course) }}" class="sidebar-link {{ $active == 'exams' ? 'active' : '' }}">
            ...
            <a href="{{ route('gradebook.leaderboard', $course) }}" class="sidebar-link {{ $active == 'leaderboard' ? 'active' : '' }}">
        ...
        @if(auth()->user()->isTeacher() && (int) $course->teacher_id === (int) auth()->id())
            ...
            <a href="{{ route('teacher.announcements.create', $course) }}" class="sidebar-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/></svg>
                Post Announcement
            </a>
